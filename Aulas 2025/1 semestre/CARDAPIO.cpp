...
int main()
{
	int op, calorias;
	calorias = 0;
	cout << "Digite: 1-Vegetariano | 2-Peixe | 3-Frango | 4-Carne -> ";
	cin >> op;
	switch (op)
	{
	...
	cout << "Digite: 1-Abacaxi | 2-Sorvete Diet | 3-Mousse Diet | 4-Mousse de Chocolate-> ";
	cin >> op;
	switch (op)
	{
	...
	cout << "Digite: 1-Cha | 2-Suco de Laranja | 3-Suco Melao | 4-Refrigerante diet  -> ";
	cin >> op;
	switch (op)
	{
		...
		case 4:	calorias = calorias + 150; break;
		default: cout << "Opcao invalida"; break;
	}
